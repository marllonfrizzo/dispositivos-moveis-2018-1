package com.example.marllonfrizzo.clima.util
...
object NetworkUtils {
    ...
    private val appKey = "cf33b70da40ac3016bacbc13340dbc55" // substitua essa String pela sua chave de autenticação do Open Weather Map
